...
import com.example.travel.databinding.ActivityDetailsBinding
...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Back Button
        val goToMainButton = findViewById<Button>(R.id.btnDetailsBack)
        goToMainButton.setOnClickListener {
            val intent = Intent(this, MainActivity::class.java)
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP) // Loại bỏ các Activity trước đó khỏi ngăn xếp
...
//        database.execSQL("CREATE TABLE IF NOT EXISTS arts (id INTEGER PRIMARY KEY, tenTacPham NVARCHAR, tenHoaSi NVARCHAR, namSangTac VARCHAR, tacPham BLOB)")
        ...
        if (info.equals("new")) {
            ...
            while (cursor.moveToNext()) {
                binding.artText.setText("Tác phẩm: " + cursor.getString(artNameIx))
                binding.artistText.setText("Họa sĩ: " + cursor.getString(artistNameIx))
                binding.yearText.setText("Năm sáng tác: " + cursor.getString(yearIx))
